  ...
  return (
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TextInput style={styles._input} placeholder="Expected Arrival Date" />
        <TextInput style={styles._input} placeholder="Driver License No." />
        <TextInput style={styles._input} placeholder="Vehicle Name" />
        <TextInput style={styles._input} placeholder="Vehicle License No." />
        <TextInput
          style={styles._input}
