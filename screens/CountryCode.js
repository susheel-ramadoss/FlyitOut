    ...
    return (
      <Container style={styles._container}>
        <Header style={{backgroundColor: 'white', elevation: 0}}>
          ...
          <Right style={{flex: 1}}>
            <Button transparent onPress={() => this.Done()}>
              <Text style={{color: '#8C57F0', fontWeight: 'bold'}}>Done</Text>
            </Button>
          </Right>
        </Header>
                ...
                <ListItem selected>
                  <Left>
                    <Text
                      style={[
                        {color: '#1F1B1B'},
                        this.state.selected === i && {color: '#8C57F0'},
                      ]}
                      onPress={() => this.setState({code: val, selected: i})}>
                      {val.name} ({val.code})
                    </Text>
                  </Left>
